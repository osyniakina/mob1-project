...
public partial class RestMainPage : ContentPage
{
    ...
    private List<Restauracja> wszystkieRestauracje;
    ...
    private async void LoadRestaurants()
    {
        ...
        wszystkieRestauracje = filtrowane.ToList();
    ...
    private void searchBar_TextChanged(object sender, TextChangedEventArgs e)
    {
        ...
        var filteredList = wszystkieRestauracje
            .Where(r => r.Nazwa.ToLower().Contains(searchText))
            .ToList();

        lista.Children.Clear();

        foreach (var rest in filteredList)
        {
            var itemBorder = new Border
            {
                StrokeShape = new RoundRectangle { CornerRadius = new CornerRadius(10) },
