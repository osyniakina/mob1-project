    ...
    internal class DBHelper
    {
        ...
        public async Task AddSampleRestauracjeAsync()
        {
            ...
            if (existing.Count == 0)
            {
                var restauracje = new List<Restauracja>
                    {
                        new Restauracja { Nazwa = "Mc Donalds", Miasto = "Warszawa", CzasPracy = "Od 08:00 do 22:00", CzasDostawy = "20-30 min", KosztDostawy = "5 zł", Kategoria = "Amerykanska" },
                        ...
                        new Restauracja { Nazwa = "Mc Donalds", Miasto = "Lublin", CzasPracy = "Od 08:00 do 22:00", CzasDostawy = "20-30 min", KosztDostawy = "5 zł", Kategoria = "Amerykanska"  },
                        ...
                        new Restauracja { Nazwa = "Mc Donalds", Miasto = "Bialystok", CzasPracy = "Od 08:00 do 22:00", CzasDostawy = "20-30 min", KosztDostawy = "5 zł", Kategoria = "Amerykanska"  },
        ...
        public async Task AddRestauracje2Async()
        {
            ...
            if (existing.Count == 9)
            {
                var restauracje = new List<Restauracja>
                    {
                        new Restauracja { Nazwa = "KFC", Miasto = "Warszawa", CzasPracy = "Od 08:00 do 24:00", CzasDostawy = "20-30 min", KosztDostawy = "Darmowa zdostawa", Kategoria = "Amerykanska" },
                        ...
                        new Restauracja { Nazwa = "KFC", Miasto = "Lublin", CzasPracy = "Od 08:00 do 24:00", CzasDostawy = "20-30 min", KosztDostawy = "Darmowa zdostawa", Kategoria = "Amerykanska"  },
                        ...
                        new Restauracja { Nazwa = "KFC", Miasto = "Bialystok", CzasPracy = "Od 08:00 do 22:00", CzasDostawy = "20-30 min", KosztDostawy = "Darmowa zdostawa", Kategoria = "Amerykanska"  },
        ...
        public async Task AddDaniaAsync()
        {
            ...
            if (existing.Count == 0)
            {
                var danie = new List<Danie>
                    {
                        new Danie { Nazwa = "Cheeseburger", Cena = 7.00F, Kategoria = 3, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "Hamburger", Cena = 6.00F, Kategoria = 3, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "McDouble", Cena = 10.20F, Kategoria = 3, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "BigMac", Cena = 21.30F, Kategoria = 3, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "McRoyal", Cena = 21.00F, Kategoria = 3, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "McChicken", Cena = 19.20F, Kategoria = 3, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "Frytki małe", Cena = 8.00F, Kategoria = 5, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "Frytki duże", Cena = 10.00F, Kategoria = 5, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "Lody truskawkowe", Cena = 10.20F, Kategoria = 6, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "Lody waniliowe", Cena = 10.00F, Kategoria = 6, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "Lody karmelowe", Cena = 10.20F, Kategoria = 6, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "Shake czekoladowy", Cena = 9.40F, Kategoria = 6, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "Coca Cola", Cena = 7.40F, Kategoria = 7, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "Fanta", Cena = 7.40F, Kategoria = 7, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "Sok pomaranczowy", Cena = 7.40F, Kategoria = 7, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "Woda", Cena = 4.00F, Kategoria = 7, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "Kawa czarna", Cena = 7.40F, Kategoria = 7, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "Ketczup Dodatkowy", Cena = 1.00F, Kategoria = 7, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "Sos Czosnkowy", Cena = 1.40F, Kategoria = 7, Restauracja = "Mc Donalds"},
                        new Danie { Nazwa = "Sos Śmietankowy", Cena = 1.40F, Kategoria = 7, Restauracja = "Mc Donalds"},
